                    ...
                    <div style={{background: 'rgba(214, 51, 132, 0)', height: '100%', width: '85%'}}>
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{
                            ...
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '100%', width: '230px'}}><span>사번</span></div>
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                            ...
                            item && (
                                <div key={index}>
                                    ...
                                    <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                        ...
                                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                             onClick={() => navigateToDetail(item.empId)}
                                        ...
                                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                             style={{height: '45px', width: '230px'}}><span>{item.empPosition}</span>
                                        </div>
                                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                             style={{height: '45px', width: '230px'}}><span>{item.deptName}</span></div>
                                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                             style={{height: '45px', width: '300px'}}><span>{item.empAmount}</span>
                                        </div>
                                    </div>
                                    <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                         style={{width: '100%'}}>
