...
function Reshuffle() {
    ...
    return (
        <div>
            <div>
              <div className="d-xxl-flex align-items-xxl-center" style={{height: '70px', paddingTop: '0px', paddingRight: '0px', paddingLeft: '0px'}}><span style={{fontWeight: 'bold', fontSize: '30px', paddingLeft: '110px', paddingRight: '0px', paddingTop: '0px', paddingBottom: '13px'}}>인사정보</span></div>
            ...
            <form onSubmit={ handleSubmit(onValid) }>
              <div style={{height: '60px', width: '1393px', paddingLeft: '0px'}}>
                <div style={{height: '60px', width: 'auto', paddingLeft: '0px'}}><span style={{paddingRight: '0px', paddingLeft: '110px'}}>이름</span><input type="text" style={{marginLeft: '47px', marginTop: '20px'}} defaultValue={detail.empName} readOnly /></div>
              </div>
              ...
              <div style={{height: '60px', marginTop: '-10px', paddingLeft: '0px', width: 'auto'}}><span style={{paddingRight: '0px', paddingLeft: '110px'}}>입사일</span><input type="text" style={{marginLeft: '31px', marginTop: '20px'}} value={detail.empStartDate} readOnly /></div>
              <div div style={{ height: '60px', display: 'flex', alignItems: 'center' }}><span style={{whiteSpace: 'nowrap',paddingRight: '30px', paddingLeft: '110px'}}>퇴직일</span>
                  <div className="d-xxl-flex align-items-xxl-center" style={{ background: 'rgba(111,66,193,0)', height: '60%', width: '100%' }}>
                      <DatePicker
                          selected={date1}
            ...
            <div style={{ height: '60px', display: 'flex', alignItems: 'center' }}>
              ...
              <div style={{height: '60px', marginTop: '-25px', paddingRight: '0px', paddingLeft: '0px', width: 'auto'}}><span style={{paddingRight: '0px', paddingLeft: '110px'}}>이메일</span><input type="text" style={{marginLeft: '31px', marginTop: '20px', paddingLeft: '0px', width: '327px'}} value={detail.empEmail} readOnly /></div>
              <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{height: '60px', marginTop: '-25px', paddingRight: '0px', paddingLeft: '0px', width: 'auto'}}><button className="btn btn-primary text-nowrap text-center d-xxl-flex justify-content-xxl-center align-items-xxl-center" data-bss-hover-animate="pulse" type="submit" style={{background: 'white', height: '26px', marginRight: '0px', marginLeft: '538px', marginTop: '0px', marginBottom: '0px', borderRadius: '0px', color: 'black', border: '1px solid black', width: '53px', paddingRight: '0px', paddingTop: '0px', paddingLeft: '0px', paddingBottom: '0px'}}>수정</button></div>
            </form>
            </div>
        </div>
    )
