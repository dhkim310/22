...
function Approval() {
  ...
  return (
    <div>
      <div>
        <div className="d-xxl-flex justify-content-xxl-start" style={{ paddingTop: '50px', width: '100%', background: 'rgba(0,0,0,0)', height: '800px' }}>
          ...
          <div style={{ height: '100%', width: '10%', background: 'rgba(13,110,253,0)', borderRight: '2px ridge rgba(128,128,128,0.32)' }}>
            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{ background: 'rgba(102,16,242,0)', width: '100%', height: '7%' }}>
              <button className="btn btn-primary" data-bss-hover-animate="pulse" type="button" style={{ background: 'rgba(13,110,253,0)', border: '1px ridge black', width: 'auto', height: 'auto', color: 'black' }}>
                새 결재 진행
              </button>
            </div>
            <div className="d-xxl-flex" style={{ width: '100%', height: 'auto', background: 'rgba(220,53,69,0)' }}>
              <span className="d-xxl-flex" style={{ width: 'auto', height: 'auto', fontWeight: 'bold', fontSize: '20px' }}>
                결재하기
              </span>
            </div>
            <div style={{ width: '100%', background: 'rgba(214,51,132,0)', height: '7%' }}>
              <button className="btn btn-primary text-start d-xxl-flex justify-content-xxl-start" data-bss-hover-animate="pulse" type="button" style={{ background: 'rgba(13,110,253,0)', borderStyle: 'none', color: 'black', width: 'auto', height: 'auto', paddingRight: '12px', paddingLeft: '0px' }}>
                결재 대기 문서
              </button>
              <button className="btn btn-primary d-xxl-flex" data-bss-hover-animate="pulse" type="button" onClick={navigateToCompleteList} style={{ background: 'rgba(13,110,253,0)', borderStyle: 'none', color: 'black', width: 'auto', height: 'auto', paddingLeft: '0px' }}>
                결재 완료 문서
              </button>
            </div>
          </div>
          <div style={{ width: '88%', height: '100%' }}>
            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{ background: 'rgba(13,110,253,0)', width: '100%', height: '8%' }}>
              ...
              <span style={{ width: 'auto', height: 'auto', fontWeight: 'bold', fontSize: '34px' }}>결재 대기 문서</span>
            </div>
            <div style={{ background: 'rgba(220,53,69,0)', height: '82%', width: '100%' }}>
              <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{ width: '100%', height: '5%', background: 'rgba(220,53,69,0)', borderTop: '2px ridge rgba(128,128,128,0.32)', borderBottom: '2px ridge rgba(128,128,128,0.32)' }}>
                <div style={{ height: '100%', width: '4%', background: 'rgba(220,53,69,0)' }} />
                <div className="d-xxl-flex align-items-xxl-center" style={{ height: '100%', width: '13%', background: 'rgba(220,53,69,0)' }}>
                  <span>기안일</span>
                </div>
                <div className="d-xxl-flex align-items-xxl-center" style={{ height: '100%', width: '41%', background: 'rgba(220,53,69,0)' }}>
                  <span>제목</span>
                </div>
                <div className="d-xxl-flex align-items-xxl-center" style={{ height: '100%', width: '8%', background: 'rgba(220,53,69,0)' }}>
                  <span>기안자</span>
                </div>
                <div className="d-xxl-flex align-items-xxl-center" style={{ height: '100%', width: '8%', background: 'rgba(220,53,69,0)' }}>
                  <span>결재권자</span>
              ...
              <div>
                {approvalList.map((item) => (
                  ...
                  >
                    <a className="d-xxl-flex list-group-item list-group-item-action flex-column align-items-start" onClick={() => navigateToDetail(item.approvalId)} style={{ height: '100%', marginBottom: '2px', width: '100%', padding: '0px', maxHeight: '5%', borderStyle: 'none' }}>
