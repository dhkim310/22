            ...
            <div>
                <div className="d-grid d-lg-flex justify-content-lg-center" style={{width: 'auto', height: '100%', minHeight: '0px', background: 'white'}}>
                    ...
                    <div style={{height: 'auto', background: 'rgba(0,0,0,0)', paddingBottom: '5px'}}>
                        <div className="d-lg-flex justify-content-lg-center" style={{height: '30px', background: 'rgba(126,126,126,0)'}}>
                        <div className="d-lg-flex justify-content-lg-start justify-content-xxl-center" style={{width: '170px', height: '35px', background: 'black'}}><span style={{fontSize: '17px', width: 'auto', color: 'white'}}>고객관리</span></div>
                        </div><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', minWidth: '98.5px', color: 'black', paddingTop: '15px'}}>&nbsp; &nbsp;리스트</button><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', color: 'black', paddingTop: '0px'}}>등록</button>
                    </div>
                    <div style={{height: 'auto', background: 'rgba(0,0,0,0)', paddingBottom: '5px'}}>
                        <div className="d-lg-flex justify-content-lg-center" style={{height: '30px', background: 'rgba(126,126,126,0)'}}>
                        <div className="d-lg-flex justify-content-lg-start justify-content-xxl-center" style={{width: '170px', height: '35px', background: 'black', color: 'white'}}><span style={{fontSize: '17px', width: 'auto'}}>용민관리</span></div>
                        </div><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', minWidth: '98.5px', color: 'black', paddingTop: '15px'}}>&nbsp; &nbsp;불주먹</button><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', color: 'black', paddingTop: '0px'}}>등록</button>
                    </div>
                    <div style={{height: 'auto', background: 'rgba(0,0,0,0)', paddingBottom: '5px'}}>
                        <div className="d-lg-flex justify-content-lg-center" style={{height: '30px', background: 'rgba(126,126,126,0)'}}>
                        <div className="d-lg-flex justify-content-lg-start justify-content-xxl-center" style={{width: '170px', height: '35px', background: 'black', color: 'white'}}><span style={{fontSize: '17px', width: 'auto'}}>현동관리</span></div>
                        </div><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', minWidth: '98.5px', color: 'black', paddingTop: '15px'}}>&nbsp; &nbsp;물주먹</button><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', color: 'black', paddingTop: '0px'}}>등록</button>
                    </div>
                    <div style={{height: 'auto', background: 'rgba(0,0,0,0)', paddingBottom: '5px'}}>
                        <div className="d-lg-flex justify-content-xxl-center" style={{height: '30px', background: 'rgba(126,126,126,0)'}}>
                        <div className="d-lg-flex justify-content-lg-start justify-content-xxl-center" style={{width: '170px', height: '35px', background: 'black', color: 'white'}}><span style={{fontSize: '17px', width: 'auto'}}>고객관리</span></div>
                        </div><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', minWidth: '98.5px', color: 'black', paddingTop: '15px'}}>&nbsp; &nbsp;리스트</button><button className="btn btn-primary text-center" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '98.5px', fontSize: '13px', color: 'black', paddingTop: '0px'}}>등록</button>
                    </div>
                    <div style={{height: 'auto', background: 'rgba(0,0,0,0)', paddingBottom: '5px'}}>
                        <div className="d-lg-flex justify-content-xxl-center" style={{height: '30px', background: 'rgba(126,126,126,0)'}}>
                    ...
                    <div className="text-end d-xxl-flex justify-content-xxl-end align-items-xxl-center" style={{height: '50px', background: 'rgba(0,0,0,0)', borderBottom: '1px ridge rgba(0,0,0,0.09)'}}><input type="search" /><button className="btn btn-primary text-nowrap" type="button" style={{background: 'rgba(13,110,253,0)', borderStyle: 'none', width: '54.3px', height: '36px', color: 'black'}}>검색</button></div>
                    <div className="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style={{width: 'auto', height: '100%', background: 'rgba(206,212,218,0)', borderBottomStyle: 'none', paddingTop: '27px'}}>
                        <div className="container" style={{maxWidth: '1800px', height: '100%'}}>
                        <div className="row d-xxl-flex justify-content-xxl-end" style={{paddingTop: '0px', height: '100%'}}>
                            <div className="col d-xxl-flex align-items-xxl-center" style={{height: '100%'}}>
                            <div style={{height: 'auto', background: 'rgba(255,255,255,0)', width: '20px'}} />
                            ...
                            <div style={{height: '200px', background: 'rgba(255,255,255,0)', width: '20px'}} />
                            ...
                            <div className="col-md-3 col-xxl-1" style={{maxWidth: '25%', height: '100%'}}><a data-bss-hover-animate="pulse" className="list-group-item list-group-item-action flex-column align-items-start" href="#" style={{height: '200px', marginBottom: '2px', width: 'auto', borderStyle: 'none', background: 'white'}}>
                            ...
                            <div className="col-md-3 col-xxl-1" style={{maxWidth: '25%', height: '100%'}}><a data-bss-hover-animate="pulse" className="list-group-item list-group-item-action flex-column align-items-start" href="#" style={{height: '200px', marginBottom: '2px', width: 'auto', background: 'white'}}>
                                <div className="d-xxl-flex justify-content-xxl-center d-flex w-100 justify-content-between" style={{background: 'black'}}>
