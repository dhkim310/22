                ...
                <div className="d-xxl-flex" style={{width: 'auto', height: '1080px'}}>
                    <div style={{background: 'rgba(214,51,132,0)', height: '100%', width: '85%'}}>
                        ...
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{
                            ...
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '45px', width: '175px'}}><span>{salaryList.salaryBank}</span></div>
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '45px', width: '200px'}}><span>{salaryList.salaryAccountNumber}</span></div>
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '45px', width: '175px'}}><span>{salaryList.salaryPayMoney}</span></div>
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '45px', width: '175px'}}><span>{salaryList.salaryBonus}</span></div>
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '45px', width: '175px'}}><span>{salaryList.salaryTax}</span></div>
                            <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                                 style={{height: '45px', width: '175px'}}><span>{salaryList.salaryPayDate}</span></div>
                        </div>
