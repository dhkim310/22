            ...
            <div className="d-xxl-flex" style={{width: 'auto', height: '1080px'}}>
                <div style={{background: 'rgba(214,51,132,0)', height: '100%', width: '85%'}}>
                    ...
                    <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center" style={{
                        ...
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                             style={{height: '45px', width: '175px'}}><span>국민은행</span></div>
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                             style={{height: '45px', width: '200px'}}><span>000-000-00000000</span></div>
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                             style={{height: '45px', width: '175px'}}><span>1000</span></div>
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                             style={{height: '45px', width: '175px'}}><span>200</span></div>
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                             style={{height: '45px', width: '175px'}}><span>150</span></div>
                        <div className="d-xxl-flex justify-content-xxl-start align-items-xxl-center"
                             style={{height: '45px', width: '175px'}}><span>2023-10-12</span></div>
                    </div>
                ...
                <div style={{background: 'rgba(13,110,253,0)', height: '100%', width: '15%'}}>
                    ...
                    <div style={{width: '100%', height: '20px', borderLeft: '2px ridge rgba(128,128,128,0.32)'}}></div>
